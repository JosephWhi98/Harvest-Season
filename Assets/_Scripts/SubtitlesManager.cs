...
public class SubtitlesManager : Singleton<SubtitlesManager>
{
    ...
    public void Update()
    {
        ...
        if (GameManager.Instance.playerController.unlockedShotgun)
        {
            ammoTextMesh.text = GameManager.Instance.playerController.gun.shotsInBarrel + " / " + GameManager.Instance.playerController.gun.totalAmmo;
        }
        else
        {
            ammoTextMesh.text = ""; 
